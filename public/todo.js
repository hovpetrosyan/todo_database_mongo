...
class Table extends Component{
	...
	mapItemToRow(item) {
		...
		input.setAttribute("name","todo");input.setAttribute("id",item._id);input.setAttribute("value",item.todo);
		td1.appendChild(input);
		let td2 = document.createElement("td");
		let btn1 = document.createElement("button");
		btn1.setAttribute("class","add");btn1.setAttribute("onclick",sendReq('put',item._id));btn1.innerHTML=edit;
		td2.appendChild(btn1);
		let td3 = document.createElement("td");
		let btn2 = document.createElement("button");
		btn2.setAttribute("class","add");btn2.setAttribute("onclick",sendReq('delete',item._id));btn2.innerHTML=del;
